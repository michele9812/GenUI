          ...
          >
            ...
            <AccordionContent className="bg-white">
              <div className="px-4 md:px-6 lg:px-8 py-2 h-fit">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 h-fit">
                  {/* Text content */}
                  ...
                  <div className="flex-shrink-0 h-fit">
                    <motion.button
                      className="w-full md:w-auto py-2 px-4 sm:py-2.5 sm:px-5 md:py-3 md:px-6 font-medium rounded-lg transition-all duration-200 hover:opacity-90 max-h-[56px] md:max-h-none"
                      style={{ 
