...
export function SeniorAccordion({
  ...
  return (
    <div className="w-full max-w-4xl mx-auto h-[320px] sm:h-[420px] md:h-[460px] lg:h-[480px] portrait-spacing landscape-spacing pl-[0px] pr-[0px] pt-[0px] pb-[0px]">
      <Accordion 
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between w-full px-4 py-3 sm:px-6 sm:py-4 pt-[8px] pb-[8px]">
                ...
                {/* Chevron Icon */}
                <ChevronDown 
                  className="h-5 w-5 text-white transition-transform duration-200 group-data-[expanded]:rotate-180" 
                />
                </div>
              </div>
              </AccordionTrigger>
