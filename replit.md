...
- **Ensured full width text containers**: Added w-full class and width: '100%' style to all text elements (H1, paragraphs) in journey-detail header section to ensure proper container filling on mobile instead of content hugging
