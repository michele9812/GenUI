...
- **Updated AirBuddy logo with cheerful pilot character**: Replaced generic airplane SVG with custom pilot character image in both welcome and journey detail pages, added overflow-hidden for proper image cropping within rounded containers
