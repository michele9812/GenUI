...
- **Ultra-compact iPhone SE card dimensions**: Reduced card size to 100/120px width and 240px height (max 320px) with tighter spacing (10px) and padding (6px) for optimal fit in 320px container
