...
- **Neutralized onboarding persona selection colors**: Removed persona-specific colors, fonts, and scaling from login page preview card - now uses neutral gray backgrounds (bg-gray-50, border-gray-200), gray icons (bg-gray-600), and standard fonts to maintain neutral appearance during persona selection phase
